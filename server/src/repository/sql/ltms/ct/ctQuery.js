  ...
  if (params.is_emergency_y !== undefined || params.is_emergency_n !== undefined) {
    ...
    if (params.request_content) {
      query += ` AND (
                    ...
                    OR cr.ct_no LIKE :request_content
                    OR cr.ct_lab_no LIKE :request_content
                )`;
...
export const findCtRequestById = async (conn, queryParams) => {
  ...
  let sqlCtInfo = `
    ...
    SELECT
      ...
      , cr.is_cutting                                                                   AS is_cutting
      , cr.is_include_tube                                                              AS is_include_tube
...
export const updateCtRequest = async (conn, queryParams) => {
  ...
  const query = `
    ...
    SET
      ...
      is_include_tube = :is_include_tube,
...
export const findTestReports = async (conn, params) => {
  ...
  let query = `
    ...
    SELECT
      ...
      ctr.report_status                               AS report_status,
      cr.ct_no                                        AS ct_no,
      cr.ct_test_seq                                  AS ct_test_seq,
      CASE 
