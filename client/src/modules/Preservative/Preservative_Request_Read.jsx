...
import PRE_SubNav from "/src/modules/Preservative/Preservative_SubNav";
...
export default function Preservative_Request_Read() {
  /* ============================== 페이지 변수 ============================== */
  ...
  const initialColumns = [
    {"key" : "request_no", "label" : "문서번호", "sortable" : true}
    ,{"key" : "status_kr", "label" : "시험완료여부", "sortable" : true}
    ,{"key" : "isReg", "label" : "보고서등록", "sortable" : true}
    ,{"key" : "class", "label" : "구분", "sortable" : true}
    ,{"key" : "source_type", "label" : "시험기관", "sortable" : true}
    ,{"key" : "request_date", "label" : "의뢰일", "sortable" : true}
    ,{"key" : "test_start_date", "label" : "시험일", "sortable" : true}
    // ,{"key" : "midTermResultDate", "label" : "중간결과예정일", "sortable" : true}
    ,{"key" : "test_expect_date", "label" : "시험완료예정일", "sortable" : true}
    ,{"key" : "request_user_id", "label" : "의뢰자", "sortable" : true}
    ,{"key" : "test_user_id", "label" : "시험담당자", "sortable" : true}
    ,{"key" : "cust_name", "label" : "업체명", "sortable" : true}
    ,{"key" : "itemName", "label" : "품명", "sortable" : true}
    ,{"key" : "lab_no", "label" : "Lab No.", "sortable" : true}
    ,{"key" : "lot_no", "label" : "Lot No.", "sortable" : true}
    ,{"key" : "result_final", "label" : "판정", "sortable" : true}
    ,{"key" : "rmName", "label" : "원료명", "sortable" : true}
    ,{"key" : "numerator", "label" : "함량(%)", "sortable" : true}
    // ,{"key" : "guideNo", "label" : "가이드라인", "sortable" : true}
    ,{"key" : "item_type", "label" : "제품유형", "sortable" : true}
    ,{"key" : "water", "label" : "Water", "sortable" : true}
    ,{"key" : "edta_2na", "label" : "Chelating Agent", "sortable" : true}
    ...
    ,{"key" : "polyol_sum", "label" : "Polyol", "sortable" : true}
  ...
  const [preSearchForm, setPreSearchForm] = useState({
    "pre_class" : ""                                // 클래스구분값
    ,"pre_doc_no" : ""                              // [기본정보]문서번호
    ,"pre_reg_date" : G_STARTDAY                    // [기본정보]의뢰등록일
    ,"pre_reg_user" : ""                            // [기본정보]의뢰등록자
    ,"pre_cust_name" : ""                           // [기본정보]고객사명
    ,"pre_sample_info" : ""                         // [기본정보]샘플정보
    ,"pre_source" : ""                              // [기본정보]시험기관
    ...
    ,"pre_sample_item_type" : ""                    // [샘플정보]제품유형(W/O)
    ...
    ,"pre_content_water" : ""                       // [샘플정보]water
    ,"pre_content_chelating_agent" : ""             // [샘플정보]chelating agent
    ,"pre_content_surfactant" : ""                  // [샘플정보]surfactant
    ,"pre_content_ethanol" : ""                     // [샘플정보]ethanol
    ,"pre_content_lipid" : ""                       // [샘플정보]lipid
    ,"pre_content_silicone" : ""                    // [샘플정보]silicone
    ,"pre_content_powder" : ""                      // [샘플정보]powder
    ,"pre_content_polyol_sum" : ""                  // [샘플정보]polyol(합계)
    ,"pre_content_glycerine" : ""                   // [샘플정보]glycerine
    ,"pre_content_propanediol" : ""                 // [샘플정보]propanediol
    ,"pre_content_dpg" : ""                         // [샘플정보]dpg
    ,"pre_content_pg" : ""                          // [샘플정보]pg
    ,"pre_content_bg" : ""                          // [샘플정보]bg
    ,"pre_content_ph" : ""                          // [샘플정보]ph
    ,"pre_content_etc" : ""                         // [샘플정보]기타

    ,"pre_test_date_start" : ""                     // [시험결과판정]시험시작일
    ,"pre_test_date_expect" : ""                    // [시험결과판정]시험완료예정일
    ,"pre_test_date_end" : ""                       // [시험결과판정]시험완료일
    ,"pre_test_user" : ""                           // [시험결과판정]시험담당자
    ,"pre_test_result_interm" : ""                  // [시험결과판정]중간결과
    ,"pre_test_result_final" : ""                   // [시험결과판정]최종결과
    ,"pre_test_remark" : ""                         // [시험결과판정]비고
    ,"pre_is_start": ""                             // [시험결과판정]시험중
    ,"pre_is_fin": ""                               // [시험결과판정]시험완료

    ,"pre_status" : ""                              // [시험결과]시험상태값(숫자)
    ,"pre_status_kr" : ""                           // [시험결과]시험상태값(국문)
  ...
  const handleResult = (item) => {
    // const { request_id, item_id, item_no, item_rate } = item;
    item.map((i) => {
      setResult((prev) => ({ 
        ...prev
        ,["item_id"]: i.item_id
  ...
  const initialSearch = async () => {
    ...
    try {
      ...
      // 응답 객체
      const res = await axios.get("/api/v2/ltms/preservative/request/read", { params });
      const resultData = res.data.data;
      const rmData = res.data.rmData;
  ...
  const search = async (e) => {
    ...
    try{
      console.log("Called Search Event");
      // 요청 파라미터 객체
      ...
      <div className="container">
        ...
        <div>
          ...
          <div className="search-information">
            <form id="preservaitve-search-form" className="" onSubmit={search}>

              {/* ↓ 검색 조건폼 1번 라인 ↓ */}
              <div className="preservative-search-grid-title">◎ 조회조건</div>
              <div className="preservative-search-grid preservative-search-grid-line-1">
              {/* <div className="preservative-search-grid-inline"> */}
                <div className="date-field">
                  <div className="preservative-search-grid-label">의뢰일</div>
                ...
                <div className="temp-field">
                  <div className="preservative-search-grid-label">문서번호</div>
                  <div></div>
                      <Search
                        listData={docNo}
                        labelKey={"name"}
                ...
                <div className="field">
                  <div className="preservative-search-grid-label">의뢰자</div>
                      <Search
                ...
                <div className="field">
                  <div className="preservative-search-grid-label">구 분</div>
                      <select 
                        className="" 
                        id="searchForm_classification" 
                        name="classification" 
              ...
              {/* ↓ 검색 조건폼 2번 라인 ↓ */}
              <div className="preservative-search-grid preservative-search-grid-line">
              {/* <div className="preservative-search-grid-inline"> */}
                <div className="field">
                  <div className="preservative-search-grid-label">업체명</div>
                      <Search
                        listData={custName}
                        labelKey={"name"}
                        inputId={"custName"}
                        inputName={"custName"}
                        placeholder={"올리브영"}
                        onSelect={(custName) => setSearchForm((prev) => ({ ...prev, "custName": custName.id}))}/>
                </div>
                <div className="field">
                  <div className="preservative-search-grid-label">품명</div>
                      <Search
                        listData={itemName}
                        labelKey={"name"}
                        inputId={"itemName"}
                ...
                <div className="field">
                  <div className="preservative-search-grid-label">Lab No.</div>
                      <Search
                        listData={labNo}
                        labelKey={"name"}
                        inputId={"labNo"}
                ...
                <div className="field">
                  <div className="preservative-search-grid-label">Lot No.</div>
                      <Search
                        listData={lotNo}
                        labelKey={"name"}
                        inputId={"lotNo"}
              ...
              {/* ↓ 검색 조건폼 3번 라인 ↓ */}
              <div className="preservative-search-grid preservative-search-grid-line-3">
                <div className="field">
                  <div className="preservative-search-grid-label">pH</div>
                  <div className="numRange">
                      <input 
                        type="text" 
                        className="" 
                        id="searchForm_phFrom" 
                        name="ph_from" 
                        placeholder="00.00"/>
                      ~
                      <input 
                ...
                <div className="field">
                  <div className="preservative-search-grid-label">Water</div>
                  <div className="numRange">
                      <input 
                        type="text" 
                        className="" 
                        id="searchForm_waterFrom" 
                        name="water_from" 
                        placeholder="00.00"/>
                      ~
                      <input 
                        type="text" 
                        className="" 
                        id="searchForm_waterTo" 
                        name="water_to" 
                        placeholder="00.00"/>
                  </div>
                </div>
                <div className="field">
                  <div className="preservative-search-grid-label">Polyol</div>
                  <div className="numRange">
                      <input 
                        type="text" 
                        className="" 
                        id="searchForm_polyolFrom" 
                        name="polyol_from" 
                        placeholder="00.00"/>
                      ~
                      <input 
                        type="text" 
                        className="" 
                        id="searchForm_polyolTo" 
                        name="polyol_to" 
                        placeholder="00.00"/>
                  </div>
                </div>
                <div className="field">
                  <div className="preservative-search-grid-label">Ethanol</div>
                  <div className="numRange">
                      <input 
                        type="text" 
                        className="" 
                        id="searchForm_ethanolFrom" 
                        name="ethanol_from" 
                        placeholder="00.00"/>
                      ~
                      <input 
              ...
              {/* ↓ 검색 조건폼 4번 라인 ↓ */}
              <div className="preservative-search-grid preservative-search-grid-line-4">
                <div className="field">
                  <div className="preservative-search-grid-label">Surfactant</div>
                  <div className="numRange">
                      <input 
                        type="text" 
                        className="" 
                        id="searchForm_surfactantFrom" 
                        name="surfactant_from" 
                        placeholder="00.00"/>
                      ~
                      <input 
                        type="text" 
                        className="" 
                        id="searchForm_surfactantTo" 
                        name="surfactant_to" 
                        placeholder="00.00"/>
                  </div>
                </div>
                <div className="field">
                  <div className="preservative-search-grid-label">Lipid</div>
                  <div className="numRange">
                      <input 
                        type="text" 
                        className="" 
                        id="searchForm_lipidFrom" 
                        name="lipid_from" 
                        placeholder="00.00"/>
                      ~
                      <input 
                        type="text" 
                        className="" 
                        id="searchForm_lipidTo" 
                        name="lipid_to" 
                        placeholder="00.00"/>
                  </div>
                </div>
                <div className="field">
                  <div className="preservative-search-grid-label">Powder</div>
                  <div className="numRange">
                      <input 
                        type="text" 
                        className="" 
                        id="searchForm_powderFrom" 
                        name="powder_from" 
                        placeholder="00.00"/>
                      ~
                      <input 
                        type="text" 
                        className="" 
                        id="searchForm_powderTo" 
                        name="powder_to" 
                        placeholder="00.00"/>
                  </div>
                </div>
                <div className="field">
                  <div className="preservative-search-grid-label">Silicone</div>
                  <div className="numRange">
                      <input 
                        type="text" 
                        className="" 
                        id="searchForm_siliconeFrom" 
                        name="silicone_from" 
                        placeholder="00.00"/>
                      ~
                      <input 
                        type="text" 
                        className="" 
                        id="searchForm_siliconeTo" 
                        name="silicone_to" 
                        placeholder="00.00"/>
                  </div>
                </div>
                <div className="field">
                  <div className="preservative-search-grid-label">원료명</div>
                      <input 
                        type="text" 
                        className="" 
                        id="searchForm_item" 
                        name="itemName" 
                        placeholder="1LAN1020"></input>
                </div>
                <div className="field"></div>
                <div className="field"></div>
                {/* <div className="field"></div> */}
              ...
              {/* ↑ 검색 조건폼 4번 라인 ↑ */}
              <div className="preservative-search-grid preservative-search-grid-line-temp">
                <div></div>
              </div>
        ...
        <div className="approve-toolbar" aria-label="필터 및 검색">
          <div className="preservative-search-grid preservative-search-grid-line">
            ...
            <div className="field">
              <label htmlFor="search" className="preservative-search-grid-label">검색</label>
              <input
                id="search"
                type="search"
            ...
            <div className="field">
              <label htmlFor="category" className="preservative-search-grid-label">카테고리</label>
            ...
            <div className="search-field">
              <label htmlFor="from" className="preservative-search-grid-label">작성일 From</label>
              <input id="from" type="date" value={from} onChange={(e) => setFrom(e.target.value)} />
            </div>

            <div className="field">
              <label htmlFor="to" className="preservative-search-grid-label">작성일 To</label>
              <input id="to" type="date" value={to} onChange={(e) => setTo(e.target.value)} />
            </div>

            <div className="field">
              <label htmlFor="rowCountByPage" className="preservative-search-grid-label">목록갯수</label>
        ...
        <div className="pre-table-wrap" role="region" tabIndex={0}>
          <table className="pre-list-table">
            <thead>
              <tr>
            ...
            <Tr
              ...
              onUserClick={(id) => {
                ...
                navigate(`/preservative/request/create?mode=update&request_id=${id}`);
      ...
      {Object.values(data).map((item) => {
        ...
        return rms.map((rm, rowIdx) => (
          <tr
            ...
            className={
              `pre-row-clickable ${isSelected ? "pre-row-selected" : ""} ${item.status=="1" ? "is-test-processing" : item.status=="2" ? "is-test-end" : ""}`
            }
          >
            {/* <Link
