...
export default function External_Request_Read() {
  ...
  const initialColumns = [
    ...
    ,{"key" : "request_no", "label" : "등록번호", "sortable" : true}
    ,{"key" : "request_user", "label" : "담당자", "sortable" : true}
    ,{"key" : "test_user", "label" : "연구원", "sortable" : true}
    ,{"key" : "custName", "label" : "고객사", "sortable" : true}
    ,{"key" : "item_name_kr", "label" : "품명", "sortable" : true}
    ,{"key" : "remark", "label" : "특이사항", "sortable" : true}
    ,{"key" : "remark_reason", "label" : "요청사항", "sortable" : true}
    ,{"key" : "order", "label" : "의뢰서", "sortable" : true}
    ,{"key" : "report", "label" : "성적서", "sortable" : true}
    ,{"key" : "receipt", "label" : "접수증", "sortable" : true}
    ,{"key" : "estimate", "label" : "견적서", "sortable" : true}
    ,{"key" : "cost_from", "label" : "비용처리", "sortable" : true}
    ,{"key" : "analysisCost", "label" : "분석비용", "sortable" : true}
    ,{"key" : "analysisFrom", "label" : "분석기관", "sortable" : true}
    ,{"key" : "expectDate", "label" : "예정일", "sortable" : true}
    ,{"key" : "representName", "label" : "이름", "sortable" : true}
    ,{"key" : "representPhone", "label" : "전화번호", "sortable" : true}
    ,{"key" : "representEmail", "label" : "메일주소", "sortable" : true}
    ,{"key" : "realCost", "label" : "결제금액", "sortable" : true}
    ,{"key" : "approve", "label" : "승인여부", "sortable" : true}
   ...
   * 외부성분분석 Mock 데이터
   */
  const externalList = MockData.external_list;
  ...
  /* 방부력테스트 데이터/상태 */
  const [prePosts, setPrePosts] = useState(externalList);
  ...
  const initialSearch = async () => {
    ...
    try {
      ...
      // 응답 객체
      const res = await axios.get("/api/v2/ltms/external/request/read", { params });
      const resultData = res.data.result;
      console.log(`\n--[Read] resultData : ${resultData.map(i => {return console.log(i)})}`);
  ...
  return (
    <>
      ...
      <div className="container">
        ...
        {/* ↓ 검색 폼 ↓ */}
        <div className="external-search-wrap">
          ...
          <div className="external-search-information">
            {/* ↓ 검색 조건 메인폼 ↓ */}
            <form id="external-search-form" className="" onSubmit={search}>

              <div className="external-search-grid-title">◎ 조회조건</div>
              {/* ↓ 검색 조건 메인폼-1번라인 ↓ */}
              <div className="external-search-grid external-search-grid-line">
              {/* <div className="preservative-search-grid-inline"> */}
                <div className="field">
                  <div className="external-search-grid-label">신제품번호</div>
                  <input type="text" placeHolder="260108-00558"/>
                </div>
                <div className="field">
                  <div className="external-search-grid-label">등록번호</div>
                  <input type="text" placeHolder="26-0001"/>
                </div>
                <div className="date-field">
                  <div className="external-search-grid-label">등록일</div>
              ...
              {/* ↓ 검색 조건 메인폼-2번라인 ↓ */}
              <div className="external-search-grid external-search-grid-line">
              {/* <div className="external-search-grid-inline"> */}
                <div className="field">
                  <div className="external-search-grid-label">담당자</div>
                  <input type="text" placeHolder="이예지"/>
                </div>
                <div className="email-field">
                  <div className="external-search-grid-label">E-MAIL</div>
                  <input type="text" placeHolder="choiyw@cosmecca.com"/>
                </div>
              ...
              <div className="external-search-grid external-search-grid-line">
                <div className="field">
                  <div className="external-search-grid-label">고객사</div>
                  <input className="" type="text" placeHolder="스킨천사"/>
                </div>
                <div className="field">
                  <div className="external-search-grid-label">제품명</div>
                  <input className="" type="text" placeHolder="제품이름입니다"/>
                </div>
                <div className="field">
                  <div className="external-search-grid-label">연구원</div>
                  <input className="" type="text" placeHolder="최연웅"/>
                </div>
                <div className="field">
                  <div className="external-search-grid-label">비용처리</div>
                  <input className="" type="text" placeHolder="자사"/>
                </div>
              </div>
              <div className="external-search-grid external-search-grid-line">
                <div className="field">
                  <div className="external-search-grid-label">요청사항</div>
                  <textarea type="text"></textarea>
                </div>
                <div className="field">
                  <div className="external-search-grid-label">특이사항</div>
                  <textarea type="text"></textarea>
                </div>
              </div>
            </form>
          ...
          <div className="external-search-information">
            {/* ↓ 검색 조건 두번째폼 ↓ */}
          <form id="external-search-form" className="" onSubmit={search}>
            <div className="external-search-grid-title">◎ 분석 정보</div>
            <div className="external-search-grid external-search-grid-line">
              <div className="field">
                <div className="external-search-grid-lable">의뢰기관</div>
                <input type="text" />
              </div>
              <div className="field">
                <div className="external-search-grid-lable">분석비용</div>
                <input type="text" />
              </div>
              <div className="reverse-field">
                <div className="external-search-grid-lable">성적서예정일</div>
            ...
            {/* <div className="external-search-grid-inline"> */}
              <div className="">
                <div className="external-search-subForm">
                  <div className="external-search-grid external-search-grid-line">
                    <div className="external-search-grid-label"
                        style={{textAlign:'center'}}>접수증</div>
                  </div>
                  <div className="external-search-grid external-search-grid-line">
              ...
              <div className="">
                <div className="external-search-subForm">
                  <div className="external-search-grid external-search-grid-line">
                    <div className="external-search-grid-label"
                        style={{textAlign:'center'}}>견적서</div>
                  </div>
                  <div className="external-search-grid external-search-grid-line">
                    <div className="empty-field">
                      <button>저장</button>
          ...
          <form id="external-search-form" className="" onSubmit={search}>
            ...
            {/* ↓ 검색 조건폼 1번 라인 ↓ */}
            <div className="external-search-grid-title">◎ 고객사 담당자정보</div>
            <div className="external-search-grid external-search-grid-line">
            {/* <div className="preservative-search-grid-inline"> */}
              <div className="field">
                <div className="external-search-grid-label">이 름</div>
                <input type="text" placeHolder="홍길동"/>
              </div>
              <div className="field">
                <div className="external-search-grid-label">연락처</div>
            ...
            <div className="external-search-grid external-search-grid-line">
              <div className="reverse-field">
                <div className="external-search-grid-label">고객사 결제금액</div>
          ...
          <div className="external-form-top-buttons">
            <div><button className="external-search-button">저장</button></div>
            <div><button className="external-search-button">보기</button></div>
            <div><button className="external-search-button">제거</button></div>
          </div>

        </div>
        {/* ↓ 검색 조건폼 제어 버튼 영역 ↓ */}
        <div className="external-form-buttons">
          ...
          <table className="pre-list-table tal">
            ...
            <Tr
              ...
              onUserClick={(id) => {
                ...
                navigate(`/external/request/create?mode=update&request_id=${id}`);
              }}
      ...
      {data.map((item) => {
        ...
        return (
          <tr
            ...
            className={`pre-row-clickable ${isSelected ? "pre-row-selected" : ""}`}
          >
              {columns.map((col) => (
                <td
                  key={`${rowKey}-${col.key}`}
